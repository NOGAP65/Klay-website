...
grain uses the existing neutralised supplier samples; paint and aluminium use
different highlight widths. Colours remain canvas pixels in forced dark mode.
...
drop (bounded to 600–3600 mm). Preview slats are nominally 25 mm aluminium and
50 mm timber/composite. Plantation blades use approximately 78 mm pitch,
