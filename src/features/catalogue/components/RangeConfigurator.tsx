  ...
  return (
    <button
      ...
      style={{
        ...
        boxSizing: 'border-box',
        padding: compact ? '0 10px' : `0 ${space.item}px`,
  ...
  if (listed) {
    return (
      <div>
        ...
        {field.showSelection && <div style={{ fontFamily: tokens.body, fontSize: 11, lineHeight: 1.35,
          color: tokens.inkSoft, marginTop: 6, minHeight: 30 }}>
          {field.choices.find(c => c.id === value)?.label}
        </div>}
        {divider && (
          <div
            aria-hidden="true"
  ...
  return (
    <div
      style={{
        ...
        background: dense ? 'transparent' : tokens.card,
        ...
        padding: fill || dense ? 0 : `${space.item}px`,
        display: 'flex',
      ...
      <div style={{ flex: '0 0 auto', paddingTop: space.snug }}>
        ...
        <button
          ...
          style={{
            ...
            background: isHovered ? tokens.ink : tokens.fillStrong,
            ...
            // full width, and — because the panel is now exactly the card's
            // height and sits flush against it — the same bottom edge.
