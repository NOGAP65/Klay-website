...
// A literal, matching CURTAIN_ENQUIRY above it. The routes module those two
// read from arrives with the architecture refactor and is not on this branch.
const WARDROBE_ENQUIRY = '/contact';
      ...
      {tabs.map(tab => {
        ...
        return (
          <button
            ...
            style={{
              flex: 1,
              // Horizontal padding comes in with the third tab: "WARDROBES" is
              // the longest label and 12px either side of it pushes the row
              // past the panel. main's scale names these sm/xxs; the refactor
              // branch calls the same two values snug/hairline.
              padding: `${space.sm}px ${space.xxs}px`,
          ...
          >
            ...
            {!isWardrobe && (
              <section>
                ...
                {/* space.md here, which is what main's scale calls the value the
                    refactor branch names space.item. */}
