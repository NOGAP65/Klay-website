                ...
                >
                  <div
                    style={{
                      ...
                      height: 56,
                      borderRadius: '50%',
                      background: hovered ? tokens.fillStrong : 'rgba(245,242,237,0.15)',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      transition: 'all 0.3s ease',
        ...
        <div style={{ marginTop: 48, textAlign: 'center' }}>
          <a
            ...
            style={{
              ...
              padding: '16px 40px',
              borderRadius: 6,
              border: `1px solid ${ctaHover ? tokens.line : 'rgba(245,242,237,0.2)'}`,
              fontFamily: tokens.body,
              fontSize: 12,
              fontWeight: 500,
              color: ctaHover ? tokens.card : tokens.onDarkMuted,
              textTransform: 'uppercase',
