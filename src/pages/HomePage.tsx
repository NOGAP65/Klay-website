...
//
// The order is an argument, not a list. It opens on the outcome, states what the
// customer gets, splits the business into the three categories they recognise,
// explains who does the work, shows what Klay makes and what it costs, catches
// the undecided, and only then hands over the configurator — by which point the
// visitor knows the range, the price and who installs it, so being asked to
// configure something is a reasonable request rather than one made of a stranger.
// Everything after the tool answers the objections that stop someone finishing:
// what the two ranges are actually for, what it looks like in a real house, and
// what other people thought.
//
// The grounds alternate warm white and parchment through the light half and drop
// to charcoal at the recommendation band, the inspiration tiles and the close, so
// the scroll has a rhythm instead of being one continuous cream field.
//
  ...
  return (
    <>
      ...
      <main style={{ background: tokens.warmWhite }}>
        ...
        {/* 7 — What Klay makes, as nine types. */}
        <RangeGrid />

        {/* 8 — The catch for anyone who read nine types and still doesn't know
            which one they need. */}
